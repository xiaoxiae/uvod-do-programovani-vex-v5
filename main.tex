...
\begin{titlepage}
    \begin{center}
        ...
        \Huge
				...
				\Large
        \vspace*{0.5em}
				v jazyce Blocky (TODO: Python?)  a prostředí RobotMesh Studio
...
Tato učebnice byla sepsána Tomášem Slámou ke vzdělávacímu programu Robotika 3 TODO (odborněji). Její cíl je seznámit čtenáře s programováním robota VEX V5 za použití programovacích jazyků TODO, v prostředí RobotMesh.
