...
\includepdf[pages=-]{Images/methodology-title.pdf}
\cleardoublepage
...
\section{Na úvod}
Tento krátký dokument je doprovodný text pro učebnici \textbf{Úvod do programování \includegraphics[height=0.65\baselineskip]{Images/vex-logo.png}.} \mbox{Jejím} cílem je poskytnout dodatečné informace vyučujícímu, který používá učebnici jako hlavní zdroj informací a příkladů.
...
Pro účastníky, kteří jsou znatelně rychlejší než ostatní, je dobré vymýšlet obtížnější variace \mbox{na problémy}, které aktuálně řeší:
\begin{itemize}
...
Dát účastníkům dostatek času na to, aby si pohráli s příklady kapitoly, převážně s těmi o jízdě na~vzdálenost. Podrobně a názorně vysvětlit, k čemu slouží bloky v příkladu na jízdu na vzdálenost, jelikož~ten~je~na~pochopení koncepčně nejtěžší.
...
Na konci kapitoly shrnout rozdíly obou metod, zejména přesnost, požadavek na senzory a \mbox{náročnost} \mbox{na~implementaci}. Důležité zdůraznit, že používání senzorů je lepší než jejich nepoužívání (pokud jsou dostupné).
