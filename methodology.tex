...
Opět je potřeba se ujistit, že všichni účastníci mají senzory ve svých prostředích nastaveny správně, často je při problémech v programu pouze nenastavený senzor.

\subsection{Teorie autonomního ovládání}
Dobrý nápad po probrání kapitoly a vyřešení příkladů shrnout rozdíly obou metod -- přesnost, požadavek na senzory, obtížnost implementace, apod.

U příkladu $\bigstar$ je dobré ukázat řešení, ideálně s nakresleným diagramem, na kterým by mělo jít dobře pochopit.
