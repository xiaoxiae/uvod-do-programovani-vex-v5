...
\fancyhead[C]{}
\fancyfoot[RO]{\raisebox{-0.25em}{\includegraphics[height=1.5\baselineskip]{Images/logolink.jpg}}}
\fancyfoot[RE]{\thepage}
\fancyfoot[C]{}
\fancyfoot[LO]{\thepage}
\fancyfoot[LE]{\raisebox{-0.25em}{\includegraphics[height=1.5\baselineskip]{Images/logolink.jpg}}}
...
\newcommand{\blockMotorStart}{\item[\block] \centerimage{2em}{Images/blocks/motor-start.png} -- \parbox{0.545\textwidth}{zapne daný motor dopředu (\textit{forward}) nebo dozadu (\mbox{\textit{reverse}}) na danou rychlost (\textit{velocity}) v procentech.}}
...
\newcommand{\blockMotorDistance}{\item[\block] \blockMotorDistanceImage -- \parbox{0.525\textwidth}{zapne motor, dokud se neotočí o daný počet stupňů (\textit{degrees}) nebo otáček (\textit{revolutions}). \mbox{Je neblokující}, což znamená, že zapne motor a jde na další blok.}}
