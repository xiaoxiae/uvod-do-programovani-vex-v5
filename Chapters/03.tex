...
\begin{document}
	...
	Všechny motory, se kterými náš robot pracují, v sobě už enkóder zabudovaný mají. Využívá ho např. blok \centerimage{1.8em}{../Images/blocks/motor-distance-start.png}, který na jeho základě měří otáčky kola.

	\begin{question}
		Kolečko nahoře odkrývá a zakrývá senzor, z čehož počítáme uraženou vzdálenost. Dokážeme z toho také určit, jakým směrem se kolečko točí, nebo budeme potřebovat kolečka dvě?
	\end{question}
	...
	Použijeme ho stejným způsobem, jako jsme používali \blockMotorDoneImage v kapitole \ref{cha:distanceride}:
